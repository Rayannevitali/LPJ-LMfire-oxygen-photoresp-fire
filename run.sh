...
mpirun -np 16  ~/LPJ_prod_16/src/lpj joboptions/standard_run.namelist -180/180/-90/90 /gpfs/ts0/projects/Research_Project-T106778/Rayanne/LPJLMfire/Outputs/36_andre.nc
